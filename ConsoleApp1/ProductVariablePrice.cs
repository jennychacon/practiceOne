...
{
    public class ProductVariablePrice : Products
    {
        ...
        #region Constructors
        public ProductVariablePrice(int productId, string productName, string measureUnit, decimal measureUnitPrice, float quantity, float taxRate) : base(productId, productName)
        {
        ...
        public override string ToString()
        {
            string cadena = $"{base.ToString()}\n\t" +
                $"Measure Unit.........:{this.GetTax(),12}\n\t" +
                $"Quantity.............:{this.GetTax(),12:N2}\n\t" +
